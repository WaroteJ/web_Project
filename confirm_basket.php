...
<head>
  ...
  <title>BDE CESI <?php echo $_SESSION['nomCentre']?> Confirmation de commande</title>
    ...
    <header class="">
        <div class="container-fluid">
            ...
            <img src="assets/img/site/cesi_logo.png" alt="Logo du cesi" height=100px >
                <h1 class="col-md-8 ml-auto">BDE CESI <?php echo $_SESSION['nomCentre']?> Confirmation de commande</h1>
            </div>
        </div>
    </header>
