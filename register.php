        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                    <form class="whole_form col-lg-6 col-md-8 col-11" method="post" action="php/scriptRegister.php">
                        ...
                        <input class="form-control" type="checkbox" name="CGU" id="CGU" required><label for="CGU">J'accepte les <a href="mentions_legales.php" target="_blank">CGU</a></label>
                        <input class="form-control" type="checkbox" name="CGV" id="CGV" required><label for="CGV">J'accepte les <a href="conditions_ventes.php" target="_blank">CGV</a></label> 
