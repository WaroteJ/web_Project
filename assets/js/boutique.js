$(function(){
  ...
  .done(function(data){
    ...
    $(".results").append('<div class="col-5 article"><a href=articles.php?art='+donnees[i].id +'><img class="picture"src= "'+ donnees[i].url +'" width=60%><div class="description">Prix: '+ donnees[i].prix +'€</div><div class="description">Nom: '+donnees[i].nom_article+'</div>'+spanC+'</div></div></div>');
